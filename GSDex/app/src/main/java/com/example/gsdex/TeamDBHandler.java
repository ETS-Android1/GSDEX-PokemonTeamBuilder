...
public class TeamDBHandler extends SQLiteOpenHelper {
    ...
    public void addPokemonToTeam(Pokemon pokemon) {
        ...
        else values.put(ABILITY_COL, pokemon.getAbility1());
    ...
    public Pokemon getPokemon(String givenName){
        ...
        return new Pokemon(name,dex_num,types[0], types[1],abilities[0],abilities[1],h_ability,HP,DEF,ATK,SPDEF,SPATK,SPEED,BST);
    }
